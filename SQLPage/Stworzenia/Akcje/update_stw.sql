...
, case when u.widok_edycja = 'EDYCJA' then '/Stworzenia/st_wybor_gry.sql?id=' ||$gra||'&offset=0&page=10'
    when u.widok_edycja <> 'EDYCJA' then 'edytuj_stworzenie.sql?gra='||$gra||'&id='||$stw_id||'' end as link
from uprawnienia u
